                ...
                <div class="row g-5">
                    <div class="col-lg-4">
                        <div class="post-entry-1 lg">
                            <a href={"/post?id=" + category.main}><img src={image} alt="" class="img-fluid" /></a>
                            <div class="post-meta"><span class="date">{title}</span> : <span>Jul 5th '22</span></div>
                            <h2><a href={"/post?id=" + category.main}>{main.title}</a></h2>
                        ...
                        <div class="row g-5">
                            <div class="col-lg-4 border-start custom-border">
                                <div class="post-entry-1">
                                    <a href={"/post?id=" + one.id}><img src={one.image} alt={one.title} class="img-fluid" /></a>
                                    <div class="post-meta"><span class="date">{title}</span> <span class="mx-1"></span> <span>Jul 5th '22</span></div>
                                    <h2><a href={"/post?id=" + one.id}>{one.title}</a></h2>
                                </div>
                                <div class="post-entry-1">
                                    <a href={"/post?id=" + two.id}><img src={two.image} alt={two.title} class="img-fluid" /></a>
                                    <div class="post-meta"><span class="date">{title}</span> <span class="mx-1"></span> <span>Jul 17th '22</span></div>
                                    <h2><a href={"/post?id=" + two.id}>{two.title}</a></h2>
                                </div>
                                <div class="post-entry-1">
                                    <a href={"/post?id=" + three.id}><img src={three.image} alt={three.title} class="img-fluid" /></a>
                                    <div class="post-meta"><span class="date">{title}</span> <span class="mx-1"></span> <span>Mar 15th '22</span></div>
                                    <h2><a href={"/post?id=" + three.id}>{three.title}</a></h2>
                                </div>
                            </div>
                            <div class="col-lg-4 border-start custom-border">
                                <div class="post-entry-1">
                                    <a href={"/post?id=" + four.id}><img src={four.image} alt={four.title} class="img-fluid" /></a>
                                    <div class="post-meta"><span class="date">{title}</span> <span class="mx-1"></span> <span>Mar 15th '22</span></div>
                                    <h2><a href={"/post?id=" + four.id}>{four.title}</a></h2>
                                </div>
                                <div class="post-entry-1">
                                    <a href={"/post?id=" + five.id}><img src={five.image} alt={five.title} class="img-fluid" /></a>
                                    <div class="post-meta"><span class="date">{title}</span> <span class="mx-1"></span> <span>Mar 15th '22</span></div>
                                    <h2><a href={"/post?id=" + five.id}>{five.title}</a></h2>
                                </div>
                                <div class="post-entry-1">
                                    <a href={"/post?id=" + six.id}><img src={six.image} alt={six.title} class="img-fluid" /></a>
                                    <div class="post-meta"><span class="date">{title}</span> <span class="mx-1"></span> <span>Mar 15th '22</span></div>
                                    <h2><a href={"/post?id=" + six.id}>{six.title}</a></h2>
                                </div>
                            </div>
