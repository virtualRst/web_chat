  ...
  return (
    ...
    <div class="footer-content">
      <div class="container">
        ...
        <div class="row g-5">
          <div class="col-lg-4">
            <h3 class="footer-heading">About EdithIndia</h3>
            <p>We love to provide you with all the possible important articles and keep you updated. We also work as a software services provider who develops Websites, Applications and Games</p>
          ...
          {/* <div class="col-lg-4">
            ...
            <ul class="footer-links footer-blog-entry list-unstyled">
              <li>
                <a href="/post" class="d-flex align-items-center">
                  <img src="assets/img/post-sq-1.jpg" alt="" class="img-fluid me-3" />
                  <div>
                    <div class="post-meta d-block"><span class="date">Culture</span> <span class="mx-1"></span> <span>Jul 5th '22</span></div>
      ...
      <div class="container">
        ...
        <div class="row justify-content-between">
          <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
            <div class="copyright">
              © Copyright <strong><span>EdithIndia</span></strong>. All Rights Reserved
            </div>

            <div class="credits">
              Designed by EdithIndia.com
            </div>
